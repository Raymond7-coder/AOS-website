...
var previousTime = 0;
var africaCenter = {
  lat: 8.6753,  // Nigeria latitude
  lng: 9.0820   // Nigeria longitude
};
var officeLocations = [
  { name: "Head Office", lat: 4.8115153, lng: 7.0297751, color: 0xff0000 },  
];
...
var drawTheMap = function() {
    ...
    var material = new THREE.PointsMaterial({
        size: 3,
        color: 0x888888, // Changed to gray
...
var init = function() {
    ...
    renderer.setClearColor(0xffffff); // Changed to white background
